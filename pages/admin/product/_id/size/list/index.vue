<template>
  <div class="admin-content col-10 no-gutters">
    ...
    <div class="mx-5 mt-5">
      <h1 class="text-capitalize h3 text-body">{{ $t('productSizes') }}</h1>
      ...
      <div class="rder bg-white rounded shadow-sm px-2 py-2 mt-4">
        ...
        <product-size-table
          :sizes="$store.state.product.productSizes"
...
import ProductSizeTable from '~/components/admin/tables/ProductSizeTable.vue'
